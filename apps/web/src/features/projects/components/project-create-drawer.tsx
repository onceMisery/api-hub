          ...
          >
            <div className="border-b border-slate-200/80 bg-white/72 px-6 py-5 backdrop-blur">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-400">New workspace</p>
                ...
                <button
                  aria-label="Close project creation panel"
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6">
              <div className="rounded-[1.8rem] border border-slate-900/85 bg-[radial-gradient(circle_at_top_left,_rgba(226,232,240,0.16),_rgba(15,23,42,0.97)_58%)] p-5 text-white shadow-[0_22px_60px_rgba(15,23,42,0.24)]">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <PreviewBadge label={draft.projectKey || normalizeProjectKey(draft.name) || "project-key"} />
                  <PreviewBadge label="Project admin access" tone="emerald" />
                  <PreviewBadge label="0 debug rules" />
                </div>
              </div>
              ...
              <div className="mt-6 space-y-4 rounded-[1.8rem] border border-white/70 bg-white/80 p-5 shadow-[0_18px_45px_rgba(15,23,42,0.06)]">
                <Field label="Project name" error={errors.name}>
                  <input
                    ...
                    placeholder="Billing Hub"
                    value={draft.name}
                  />
                </Field>

                <Field label="Project key" error={errors.projectKey}>
                  <input
                ...
                <Field label="Project description" error={errors.description}>
                  <textarea
                    ...
                    placeholder="Billing APIs, reconciliation flows, and settlement webhooks."
